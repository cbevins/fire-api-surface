...
test('7: MeshLine.valueAtDistance()', () => {
  ...
  expect(line.valueAt(0)).toEqual(0)
  expect(line.valueAt(50)).toEqual(0)
  expect(line.valueAt(99.999)).toEqual(0)

  expect(line.valueAt(100)).toEqual(1)
  expect(line.valueAt(199)).toEqual(1)
  expect(line.valueAt(200)).toEqual(2)
  expect(line.valueAt(299)).toEqual(2)
})
